...
this.noHeader=!1;this.attachHeader();this.attachHeader(0,0,"_aFoot");this.setSizes();e&&this.parseXML();this.obj.scrollTop=0;this.dragAndDropOff&&this.dragger.addDragLanding(this.entBox,this);this._initDrF&&this._initD();this._init_point&&this._init_point()}};this.setColumnSizes=function(e){for(var a=0,b=[],c=0,d=0;d<this._cCount;d++)if(this.initCellWidth[d]=="*"&&!this._hrrar[d])this._awdth=!1,b.push(d);else{if(this.cellWidthType=="%"){typeof this.cellWidthPC[d]=="undefined"&&(this.cellWidthPC[d]=
this.initCellWidth[d]);var h=e*this.cellWidthPC[d]/100||0;c>0.5&&(h++,c--);var l=this.cellWidthPX[d]=Math.floor(h),c=c+h-l}else typeof this.cellWidthPX[d]=="undefined"&&(this.cellWidthPX[d]=this.initCellWidth[d]);this._hrrar[d]||(a+=this.cellWidthPX[d]*1)}if(b.length){var k=Math.floor((e-a)/b.length);k<0&&(k=1);for(d=0;d<b.length;d++){var m=Math.max(this._drsclmW?this._drsclmW[b[d]]||0:0,k);this.cellWidthPX[b[d]]=m;a+=m}if(e>a){var n=b[b.length-1];this.cellWidthPX[n]+=e-a;a=e}this._setAutoResize()}this.obj.style.width=
a+"px";this.hdr.style.width=a+"px";if(this.ftr)this.ftr.style.width=a+"px";this.chngCellWidth();return a};this.setSizes=function(){if(this.hdr.rows[0]){var e=this.quirks=_isIE&&document.compatMode=="BackCompat",a=(this.entBox.offsetWidth-this.entBox.clientWidth)/2;if(!this.dontSetSizes)if(this.globalBox){var b=(this.globalBox.offsetWidth-this.globalBox.clientWidth)/2;if(this._delta_x&&!this._realfake){var f=this.globalBox.clientWidth;this.globalBox.style.width=this._delta_x;this.entBox.style.width=
Math.max(0,this.globalBox.clientWidth+(e?b*2:0)-this._fake.entBox.clientWidth)+"px";f!=this.globalBox.clientWidth&&this._fake._correctSplit(this._fake.entBox.clientWidth)}if(this._delta_y&&!this._realfake)this.globalBox.style.height=this._delta_y,this.entBox.style.overflow=this._fake.entBox.style.overflow="hidden",this.entBox.style.height=this._fake.entBox.style.height=this.globalBox.clientHeight+(e?b*2:0)+"px"}else{if(this._delta_x)this.entBox.parentNode&&this.entBox.parentNode.tagName=="TD"?(this.entBox.style.width=
"1px",this.entBox.style.width=parseInt(this._delta_x)*this.entBox.parentNode.clientWidth/100-a*2+"px"):this.entBox.style.width=this._delta_x;if(this._delta_y)this.entBox.style.height=this._delta_y}window.clearTimeout(this._sizeTime);if(!this.entBox.offsetWidth&&(!this.globalBox||!this.globalBox.offsetWidth))this._sizeTime=window.setTimeout(function(){c.setSizes&&c.setSizes()},250);else{var d=!this._wthB&&(this.entBox.cmp||this._delta_x)&&(this.skin_name||"").indexOf("dhx")==0&&!e?2:0,h=!this._wthB&&
...
this.objBox.style.overflowX=="scroll",q=this.hdr.clientHeight,s=this.ftr?this.ftr.clientHeight:0,u=m,t=o-q-s;this._awdth&&this._awdth[0]&&this._awdth[1]==99999&&(r=0);if(this._ahgr&&(t=this._ahgrMA?this.entBox.parentNode.clientHeight-q-s:this.obj.offsetHeight+(r?k:0)+(this._correction_y||0),this._ahgrM&&(t=this._ahgrF?Math.min(this._ahgrM,t+q+s)-q-s:Math.min(this._ahgrM,t)),l&&t>=this.obj.scrollHeight+(r?k:0)))l=!1,this.setColumnSizes(n-(this._correction_x||0));if(this._awdth&&this._awdth[0]){if(this.cellWidthType==
"%")this.cellWidthType="px";this._fake&&(p+=this._fake.entBox.clientWidth);u=Math.min(Math.max(p+(l?k:0),this._awdth[2]),this._awdth[1])+(this._correction_x||0);this._fake&&(u-=this._fake.entBox.clientWidth)}t=Math.max(0,t);this._ff_size_delta=this._ff_size_delta==0.1?0.2:0.1;if(!_isFF)this._ff_size_delta=0;if(!this.dontSetSizes)this.entBox.style.width=Math.max(0,u+(e?2:0)*a+this._ff_size_delta)+"px",this.entBox.style.height=t+(e?2:0)*a+q+s+"px";this.objBox.style.height=t+(e&&!l?2:0)*a+"px";this.hdrBox.style.height=
q+"px";t!=o&&this.doOnScroll(0,!this._srnd);var v=this["setSizes_"+this.skin_name];v&&v.call(this);this.setSortImgPos();q!=this.hdr.clientHeight&&this._ahgr&&this.setSizes();this.callEvent("onSetSizes",[])}}};this.setSizes_clear=function(){var e=this.hdr.offsetHeight,a=this.entBox.offsetWidth,b=e+this.objBox.offsetHeight;this._topMb.style.top=(e||0)+"px";this._topMb.style.width=a+20+"px";this._botMb.style.top=b-3+"px";this._botMb.style.width=a+20+"px"};this.chngCellWidth=function(){if(_isOpera&&this.ftr)this.ftr.width=
this.objBox.scrollWidth+"px";for(var e=this._cCount,a=0;a<e;a++)if(this.hdr.rows[0].cells[a].style.width=this.cellWidthPX[a]+"px",this.obj.rows[0].childNodes[a].style.width=this.cellWidthPX[a]+"px",this.ftr)this.ftr.rows[0].cells[a].style.width=this.cellWidthPX[a]+"px"};this.setDelimiter=function(e){this.delim=e};this.setInitWidthsP=function(e,a){this.cellWidthType="%";this.initCellWidth=e.split(this.delim.replace(/px/gi,""));a||this._setAutoResize()};this._setAutoResize=function(){if(!this._realfake){var e=
window,a=this;dhtmlxEvent(window,"resize",function(){window.clearTimeout(a._resize_timer);if(a._setAutoResize)a._resize_timer=window.setTimeout(function(){a.setSizes&&a.setSizes();a._fake&&a._fake._correctSplit()},100)})}};this.setInitWidths=function(e){this.cellWidthType="px";this.initCellWidth=e.split(this.delim);if(_isFF)for(var a=0;a<this.initCellWidth.length;a++)this.initCellWidth[a]!="*"&&(this.initCellWidth[a]=parseInt(this.initCellWidth[a]))};this.enableMultiline=function(e){this.multiLine=
convertStringToBoolean(e)};this.enableMultiselect=function(e){this.selMultiRows=convertStringToBoolean(e)};this.setImagesPath=this.setImagePath=function(e){this.imgURL=e};this.setIconsPath=this.setIconPath=function(e){this.iconURL=e};this.changeCursorState=function(e){var a=e.target||e.srcElement;a.tagName!="TD"&&(a=this.getFirstParentOfType(a,"TD"));if(a){if(a.tagName=="TD"&&this._drsclmn&&!this._drsclmn[a._cellIndex])return a.style.cursor="default";var b=(e.layerX||0)+(!_isIE&&e.target.tagName==
"DIV"?a.offsetLeft:0);a.style.cursor=a.offsetWidth-(e.offsetX||(parseInt(this.getPosition(a,this.hdrBox))-b)*-1)<(_isOpera?20:10)?"E-resize":"default";if(_isOpera)this.hdrBox.scrollLeft=this.objBox.scrollLeft}};this.startColResize=function(a){this.resized&&this.stopColResize();this.resized=null;var b=a.target||a.srcElement;b.tagName!="TD"&&(b=this.getFirstParentOfType(b,"TD"));var i=a.clientX,f=this.hdr.offsetWidth,d=parseInt(b.offsetWidth);if(b.tagName=="TD"&&b.style.cursor!="default"&&(!this._drsclmn||
this._drsclmn[b._cellIndex]))c._old_d_mm=document.body.onmousemove,c._old_d_mu=document.body.onmouseup,document.body.onmousemove=function(a){c&&c.doColResize(a||window.event,b,d,i,f)},document.body.onmouseup=function(){c&&c.stopColResize()}};this.stopColResize=function(){document.body.onmousemove=c._old_d_mm||"";document.body.onmouseup=c._old_d_mu||"";this.setSizes();this.doOnScroll(0,1);this.callEvent("onResizeEnd",[this])};this.doColResize=function(a,b,c,f,d){b.style.cursor="E-resize";this.resized=
...
d?2:0):d?this.doClick(l,c,3,h):this.doClick(l,c,0,h);g&&this.editCell()};this.moveToVisible=function(a,b){if(this.pagingOn){var c=Math.floor(this.getRowIndex(a.parentNode.idd)/this.rowsBufferOutSize)+1;c!=this.currentPage&&this.changePage(c)}try{if(a.offsetHeight){var d=a.offsetLeft+a.offsetWidth+20,g=0;d>this.objBox.offsetWidth+this.objBox.scrollLeft?a.offsetLeft>this.objBox.scrollLeft&&(g=a.offsetLeft-5):a.offsetLeft<this.objBox.scrollLeft&&(d-=a.offsetWidth*2/3,d<this.objBox.scrollLeft&&(g=a.offsetLeft-
...
20);if(this._fake)this._fake.objBox.scrollTop=this.objBox.scrollTop;b._r_select=c}else{this.selectCell(c,this.cell._cellIndex,!0,!1,!1,this.multiLine||this._srnd);if(!this.multiLine&&!this._srnd&&!this._realfake&&(this.objBox.scrollTop=this.getRowById(this.getRowId(c)).offsetTop,this._fake))this._fake.objBox.scrollTop=this.objBox.scrollTop;b._r_select=null}}};this.doKey=function(a){if(!a)return!0;if((a.target||a.srcElement).value!==window.undefined){var b=a.target||a.srcElement;if(!b.parentNode||
...
[b._cellIndexS,a||window.event]))return!1;c.sortField(b._cellIndexS,!1,b)}this.grid.resized=null};this.deleteSelectedRows=function(){var a=this.selectedRows.length;if(a!=0){var b=this.selectedRows;this.selectedRows=dhtmlxArray();for(var c=a-1;c>=0;c--){var d=b[c];if(this.deleteRow(d.idd,d)){if(d==this.row)var g=c}else this.selectedRows[this.selectedRows.length]=d}if(g)try{g+1>this.rowsCol.length&&g--,this.selectCell(g,0,!0)}catch(h){this.cell=this.row=null}}};this.getSelectedRowId=function(){for(var a=
...
b[0]),d=this.xmlLoader.doXPath("./settings",b[0]),e="setInitWidths",j=!1;if(d[0])for(var i=0;i<d[0].childNodes.length;i++)switch(d[0].childNodes[i].tagName){case "colwidth":d[0].childNodes[i].firstChild&&d[0].childNodes[i].firstChild.data=="%"&&(e="setInitWidthsP");break;case "splitat":j=d[0].childNodes[i].firstChild?d[0].childNodes[i].firstChild.data:!1}this._launchCommands(this.xmlLoader.doXPath("./beforeInit/call",b[0]));if(c.length>0){this.hdr.rows.length>0&&this.clearAll(!0);for(var f=[[],[],
...
i=0;i<j;i++)e.appendChild(document.createElement("TH")),e.childNodes[i]._cellIndex=i;_isIE&&_isIE<8?e.style.position="absolute":e.style.height="auto"}var f=a[1],c=document.createElement("TR");b.rows[0].parentNode.appendChild(c);for(i=0;i<a[0].length;i++)if(a[0][i]=="#cspan"){var g=c.cells[c.cells.length-1];g.colSpan=(g.colSpan||1)+1}else if(a[0][i]=="#rspan"&&b.rows.length>1){for(var h=b.rows.length-2,l=!1,g=null;!l;){for(var g=b.rows[h],k=0;k<g.cells.length;k++)if(g.cells[k]._cellIndex==i){l=k+1;
break}h--}g=g.cells[l-1];g.rowSpan=(g.rowSpan||1)+1}else{var m=document.createElement("TD");m._cellIndex=m._cellIndexS=i;if(this._hrrar&&this._hrrar[i]&&!_isIE)m.style.display="none";if(typeof a[0][i]=="object")m.appendChild(a[0][i]);else if(m.innerHTML=this.forceDivInHeader?"<div class='hdrcell'>"+(a[0][i]||"&nbsp;")+"</div>":a[0][i]||"&nbsp;",(a[0][i]||"").indexOf("#")!=-1)if(d=a[0][i].match(/(^|{)#([^}]+)(}|$)/)){var n="_in_header_"+d[2];if(this[n])this[n](this.forceDivInHeader?m.firstChild:m,
i,a[0][i].split(d[0]))}if(f)m.style.cssText=f[i];c.appendChild(m)}var o=b;if(_isKHTML)b._kTimer&&window.clearTimeout(b._kTimer),b._kTimer=window.setTimeout(function(){b.rows[1].style.display="none";window.setTimeout(function(){b.rows[1].style.display=""},1)},500)},forEachRow:function(a){for(var b in this.rowsAr)this.rowsAr[b]&&this.rowsAr[b].idd&&a.apply(this,[this.rowsAr[b].idd])},forEachRowA:function(a){for(var b=0;b<this.rowsBuffer.length;b++)this.rowsBuffer[b]&&a.call(this,this.render_row(b).idd)},
...
eXcell_tree.prototype.setValue,eXcell_tree.prototype.setValue=function(a){var b=this.grid._h2.get[this.cell.parentNode.idd];b&&this.cell.parentNode.valTag?this.setLabel(a):this.setValueX(a)};var b=this.cellType._dhx_find("tree");a.getXMLTopNode("rows");var c=a.doXPath("//rows")[0].getAttribute("parent")||0,d={};this._refresh_mode[2]&&(b!=-1?this._h2.forEachChild(c,function(a){d[a.id]=!0},this):this.forEachRow(function(a){d[a]=!0}));for(var e=a.doXPath("//row"),j=0;j<e.length;j++){var i=e[j],f=i.getAttribute("id");
d[f]=!1;c=i.parentNode.getAttribute("id")||c;if(this.rowsAr[f]&&this.rowsAr[f].tagName!="TR")this._h2?this._h2.get[f].buff.data=i:this.rowsBuffer[this.getRowIndex(f)].data=i,this.rowsAr[f]=i;else if(this.rowsAr[f])this._process_xml_row(this.rowsAr[f],i,-1),this._postRowProcessing(this.rowsAr[f],!0);else if(this._refresh_mode[1]){var g={idd:f,data:i,_parser:this._process_xml_row,_locator:this._get_xml_data},h=this.rowsBuffer.length;this._refresh_mode[1]=="top"?(this.rowsBuffer.unshift(g),h=0):this.rowsBuffer.push(g);
if(this._h2)reset=!0,this._h2.add(f,i.parentNode.getAttribute("id")||i.parentNode.getAttribute("parent")).buff=this.rowsBuffer[this.rowsBuffer.length-1];this.rowsAr[f]=i;i=this.render_row(h);this._insertRowAt(i,h?-1:0)}}if(this._refresh_mode[2])for(f in d)d[f]&&this.rowsAr[f]&&this.deleteRow(f);this._refresh_mode=null;if(window.eXcell_tree)eXcell_tree.prototype.setValue=eXcell_tree.prototype.setValueX;reset&&this._renderSort();if(this._f_rowsBuffer)this._f_rowsBuffer=null,this.filterByAll()},getCustomCombo:function(a,
...
k34_0_0:function(){this.pagingOn?this.changePage(this.currentPage+1):this.scrollPage(1)},k37_0_0:function(){if(!this.editor&&this.isTreeGrid())this.collapseKids(this.row);else return!1},k39_0_0:function(){if(!this.editor&&this.isTreeGrid())this.expandKids(this.row);else return!1},k40_0_0:function(){var a=this._realfake?this._fake:this;if(this.editor&&this.editor.combo)this.editor.shiftNext();else{if(!this.row.idd)return;var b=Math.max(a._r_select||0,this.getRowIndex(this.row.idd)),c=this._nextRow(b,
1);if(c)a._r_select=null,this.selectCell(c,this.cell._cellIndex,!0),a.pagingOn&&a.showRow(c.idd);else{if(!this.callEvent("onLastRow",[]))return!1;this._key_events.k34_0_0.apply(this,[]);this.pagingOn&&this.rowsCol[b+1]&&this.selectCell(b+1,0,!0)}}this._still_active=!0},k38_0_0:function(){var a=this._realfake?this._fake:this;if(this.editor&&this.editor.combo)this.editor.shiftPrev();else{if(!this.row.idd)return;var b=this.getRowIndex(this.row.idd)+1;if(b!=-1&&(!this.pagingOn||b!=1)){var c=this._nextRow(b-
1,-1);this.selectCell(c,this.cell._cellIndex,!0);a.pagingOn&&c&&a.showRow(c.idd)}else this._key_events.k33_0_0.apply(this,[])}this._still_active=!0}},_build_master_row:function(){for(var a=document.createElement("DIV"),b=["<table><tr>"],c=0;c<this._cCount;c++)b.push("<td></td>");b.push("</tr></table>");a.innerHTML=b.join("");this._master_row=a.firstChild.rows[0]},_prepareRow:function(a){this._master_row||this._build_master_row();for(var b=this._master_row.cloneNode(!0),c=0;c<b.childNodes.length;c++){b.childNodes[c]._cellIndex=
...
if(this.isTreeGrid())this.sortTreeRows(a,b,c);else{var d={},e=this.cellType[a],j="getValue";e=="link"&&(j="getContent");if(e=="dhxCalendar"||e=="dhxCalendarA")j="getDate";for(var i=0;i<this.rowsBuffer.length;i++)d[this.rowsBuffer[i].idd]=this._get_cell_value(this.rowsBuffer[i],a,j);this._sortRows(a,b,c,d)}this.callEvent("onAfterSorting",[a,b,c])},_sortCore:function(a,b,c,d,e){var j="sort";if(this._sst)e.stablesort=this.rowsCol.stablesort,j="stablesort";if(b=="str")e[j](function(a,b){return c=="asc"?
d[a.idd]>d[b.idd]?1:d[a.idd]<d[b.idd]?-1:0:d[a.idd]<d[b.idd]?1:d[a.idd]>d[b.idd]?-1:0});else if(b=="int")e[j](function(a,b){var e=parseFloat(d[a.idd]),e=isNaN(e)?-99999999999999:e,h=parseFloat(d[b.idd]),h=isNaN(h)?-99999999999999:h;return c=="asc"?e-h:h-e});else if(b=="date")e[j](function(a,b){var e=Date.parse(d[a.idd])||Date.parse("01/01/1900"),h=Date.parse(d[b.idd])||Date.parse("01/01/1900");return c=="asc"?e-h:h-e})},_sortRows:function(a,b,c,d){this._sortCore(a,b,c,d,this.rowsBuffer);this._reset_view();
...
0;e<this.rowsBuffer.length;e++)if(this.rowsBuffer[e]&&this.rowsBuffer[e].idd==a){this.rowsBuffer._dhx_removeAt(e);d=e;break}}this.rowsAr[a]=null;for(e=0;e<this.selectedRows.length;e++)this.selectedRows[e].idd==a&&this.selectedRows._dhx_removeAt(e);if(this._srnd){for(e=0;e<this._fillers.length;e++){var j=this._fillers[e];j&&this._update_fillers(e,j[1]>=d?-1:0,j[0]>=d?-1:0)}this._update_srnd_view()}this.pagingOn&&this.changePage();this._realfake||this.callEvent("onAfterRowDeleted",[a,c]);this.callEvent("onGridReconstructed",
...
this.rowsAr[d.idd]=d;if(this._fillers){this.rowsCol._dhx_insertAt(c,null);this.rowsBuffer._dhx_insertAt(c,d);this._fake&&this._fake.rowsCol._dhx_insertAt(c,null);this.rowsAr[d.idd]=d;for(var j=!1,i=0;i<this._fillers.length;i++){var f=this._fillers[i];if(f&&f[0]<=c&&f[0]+f[1]>=c){f[1]+=1;var g=f[2].firstChild.style.height=parseInt(f[2].firstChild.style.height)+this._srdh+"px",j=!0;if(this._fake)this._fake._fillers[i][1]++,this._fake._fillers[i][2].firstChild.style.height=g}f&&f[0]>c&&(f[0]+=1,this._fake&&
this._fake._fillers[i][0]++)}j||this._fillers.push(this._add_filler(c,1,c==0?{parentNode:this.obj.rows[0].parentNode,nextSibling:this.rowsCol[1]}:this.rowsCol[c-1]));return d}this.rowsBuffer._dhx_insertAt(c,d);return this._insertRowAt(d,c)},addRow:function(a,b,c){var d=this._addRow(a,b,c);this.dragContext||this.callEvent("onRowAdded",[a]);this.pagingOn&&this.changePage(this.currentPage);this._srnd&&this._update_srnd_view();d._added=!0;this._ahgr&&this.setSizes();this.callEvent("onGridReconstructed",
...
a.ind());a.nid=a.sid;a.sobj.callEvent("onGridReconstructed",[])}}else{var g;this._h2&&typeof a.tid!="undefined"&&a.dropmode=="sibling"&&(this._sbmod||a.tid)?a.alfa&&this._sbmod&&this._h2.get[a.tid].childs.length?(this.openItem(a.tid),g=a.uid().tobj.addRowBefore(a.nid,a.data(),this._h2.get[a.tid].childs[0].id,a.img(),a.childs())):g=a.uid().tobj.addRowAfter(a.nid,a.data(),a.tid,a.img(),a.childs()):g=a.uid().tobj.addRow(a.nid,a.data(),a.ind(),a.pid(),a.img(),a.childs());g._attrs=a.attrs();if(a.source==
"tree"){this.callEvent("onRowAdded",[a.nid]);var h=a.sobj._globalIdStorageFind(a.sid);if(h.childsCount){for(var e=a.copy().set("tid",a.nid).set("dropmode",a.target=="grid"?"sibling":"child"),b=0;b<h.childsCount;b++)a.tobj._dragRoutine(e.set("sid",h.childNodes[b].id)),a.mode=="move"&&b--;e.close()}}else if(a.tobj._copyUserData(a),this.callEvent("onRowAdded",[a.nid]),a.source=="treeGrid"){if(a.sobj==a.tobj)g._xml=a.sobj.rowsAr[a.sid]._xml;var i=a.sobj._h2.get[a.sid];if(i&&i.childs.length){e=a.copy().set("tid",
a.nid);a.target=="grid"?e.set("dropmode","sibling"):(e.tobj.openItem(a.tid),e.set("dropmode","child"));for(var k=i.childs.length,b=0;b<k;b++)if(a.sobj.render_row_tree(null,i.childs[b].id),a.tobj._dragRoutine(e.set("sid",i.childs[b].id)),k!=i.childs.length)b--,k=i.childs.length;e.close()}}if(a.mode=="move"&&(a.sobj[a.source=="tree"?"deleteItem":"deleteRow"](a.sid),a.sobj==a.tobj&&!a.tobj.rowsAr[a.sid]))a.tobj.changeRowId(a.nid,a.sid),a.nid=a.sid}};
...
this.row==a.parentNode)this.selectCell(a.parentNode,a._cellIndex,!0),this._still_active=!0}},k9_0_1:function(){this.editStop();if(!this.callEvent("onTab",[!1]))return!0;if(!(this.cell&&this.cell._cellIndex==0)){var a=this._getNextCell(null,-1);if(a&&this.row==a.parentNode)this.selectCell(a.parentNode,a._cellIndex,!0),this._still_active=!0}},k113_0_0:function(){this._f2kE&&this.editCell()},k32_0_0:function(){var a=this.cells4(this.cell);if(!a.changeState||a.changeState()===!1)return!1},k27_0_0:function(){this.editStop(!0);
this._still_active=!0},k33_0_0:function(){this.pagingOn?this.changePage(this.currentPage-1):this.scrollPage(-1)},k34_0_0:function(){this.pagingOn?this.changePage(this.currentPage+1):this.scrollPage(1)},k37_0_0:function(){if(this.editor)return!1;this.isTreeGrid()?this.collapseKids(this.row):this._key_events.k9_0_1.call(this)},k39_0_0:function(){if(this.editor)return!1;!this.editor&&this.isTreeGrid()?this.expandKids(this.row):this._key_events.k9_0_0.call(this)},k37_1_0:function(){if(this.editor)return!1;
this.selectCell(this.row,0,!0)},k39_1_0:function(){if(this.editor)return!1;this.selectCell(this.row,this._cCount-1,!0)},k38_1_0:function(){if(this.editor||!this.rowsCol.length)return!1;this.selectCell(this.rowsCol[0],this.cell._cellIndex,!0)},k40_1_0:function(){if(this.editor||!this.rowsCol.length)return!1;this.selectCell(this.rowsCol[this.rowsCol.length-1],this.cell._cellIndex,!0)},k38_0_1:function(){if(this.editor||!this.rowsCol.length)return!1;var a=this.row.rowIndex,b=this._nextRow(a-1,-1);if(!b||
b._sRow||b._rLoad)return!1;this.selectCell(b,this.cell._cellIndex,!0,!0)},k40_0_1:function(){if(this.editor||!this.rowsCol.length)return!1;var a=this.row.rowIndex,b=this._nextRow(a-1,1);if(!b||b._sRow||b._rLoad)return!1;this.selectCell(b,this.cell._cellIndex,!0,!0)},k38_1_1:function(){if(this.editor||!this.rowsCol.length)return!1;for(var a=this.row.rowIndex,b=a-1;b>=0;b--)this.selectCell(this.rowsCol[b],this.cell._cellIndex,!0,!0)},k40_1_1:function(){if(this.editor||!this.rowsCol.length)return!1;
for(var a=this.row.rowIndex,b=a;b<this.rowsCol.length;b++)this.selectCell(this.rowsCol[b],this.cell._cellIndex,!0,!0)},k40_0_0:function(){var a=this._realfake?this._fake:this;if(this.editor&&this.editor.combo)this.editor.shiftNext();else{if(this.editor)return!1;var b=Math.max(a._r_select||0,this.getRowIndex(this.row.idd)),c=this._nextRow(b,1);if(c)a._r_select=null,this.selectCell(c,this.cell._cellIndex,!0),a.pagingOn&&a.showRow(c.idd);else{if(!this.callEvent("onLastRow",[]))return!1;this._key_events.k34_0_0.apply(this,
...
1):this.scrollPage(1)},k38_0_0:function(){var a=this._realfake?this._fake:this;if(this.editor&&this.editor.combo)this.editor.shiftPrev();else{if(this.editor)return!1;if(this.row.idd){var b=this.getRowIndex(this.row.idd)+1;if(b!=-1&&(!this.pagingOn||b!=1)){var c=this._nextRow(b-1,-1);this.selectCell(c,this.cell._cellIndex,!0);a.pagingOn&&c&&a.showRow(c.idd)}else this._key_events.k33_0_0.apply(this,[])}}},k_other:function(a){if(this.editor)return!1;if(!a.ctrlKey&&a.keyCode>=40&&(a.keyCode<91||a.keyCode>
95&&a.keyCode<111||a.keyCode>187)&&this.cell){var b=this.cells4(this.cell);if(b.isDisabled())return!1;var c=b.getValue();b.editable!==!1&&b.setValue("");this.editCell();this.editor?(this.editor.val=c,this.editor.obj&&this.editor.obj.select&&this.editor.obj.select()):b.setValue(c)}}};
